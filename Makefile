...
BIN		= echo pwd ls hole 2048 joseph
...
hole.o: hole.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<

hole : hole.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?
...
joseph.o: joseph.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<
joseph : joseph.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?
